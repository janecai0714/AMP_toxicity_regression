...
if __name__ == "__main__":
    max_num_split = 5
    feature_name_list = ["CTDD", "QSOrder", "CTDC", "CTDT"] #"QSOrder", "CTDC", "CTDT"
    regressor_name_list = ["SVM", "RF"] #, "RF", "DT", "KNN"

    data_list, encoding_list, regressor_list, mse_list, r2_list, pcc_list, ktc_list = [], [], [], [], [], [], []
    for i in range(max_num_split):
        train_csv = "/home/jianxiu/Documents/amp_toxicity_regression/data/" + str(i) + "/train.csv"
        train_fasta = "/home/jianxiu/Documents/amp_toxicity_regression/data/" + str(i) + "/train.fasta"
        test_csv = "/home/jianxiu/Documents/amp_toxicity_regression/data/" + str(i) + "/test.csv"
        test_fasta = "/home/jianxiu/Documents/amp_toxicity_regression/data/" + str(i) + "/test.fasta"

        csv2fasta_func(train_csv, train_fasta)
        csv2fasta_func(test_csv, test_fasta)

        train_df = pd.read_csv(train_csv)
        y_train = train_df["pHD50"].values
        test_df = pd.read_csv(test_csv)
        y_test = test_df["pHD50"].values
        for feature_name in feature_name_list:
            train_ft_df = GeneIfeature(train_fasta, ft_name=feature_name)
            test_ft_df = GeneIfeature(test_fasta, ft_name=feature_name)
            train_ft_path = "/home/jianxiu/Documents/amp_toxicity_regression/data/" + str(i) + "/train_" + feature_name + ".pkl"
            test_ft_path = "/home/jianxiu/Documents/amp_toxicity_regression/data/" + str(i) + "/test_" + feature_name + ".pkl"
